...
class AddTaskPage(tk.Frame):
    ...
    def build_ui(self):
        ...
        notif_frame.grid(row=4, column=1, sticky='w', pady=(0, 10))
        tk.Label(form, text="Send notification", font=label_font, bg='white')\
        ...
        tk.Label(notif_frame, text="days", font=entry_font, bg="white").pack(side="left", padx=5)
        self.notify_hours = tk.Spinbox(notif_frame, from_=0, to=23, width=5, font=entry_font)
        self.notify_hours.pack(side="left", padx=(10, 0))
        tk.Label(notif_frame, text="hours", font=entry_font, bg="white").pack(side="left", padx=5)
